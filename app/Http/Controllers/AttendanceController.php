...
class AttendanceController extends Controller
{
    ...
    {
        $month =
            Carbon::parse($request->attendance_timestamp)->month ??
            Carbon::now()->month;
        $year =
            Carbon::parse($request->attendance_timestamp)->year ??
            Carbon::now()->year;
    ...
    public function daily_attendance_store(Request $request)
    {
        try {
            $last_id = EmployeeAttendance::updateOrCreate(
                ...
                [
                    $request->attendance_day_column =>
                        $request->attendance_text,
