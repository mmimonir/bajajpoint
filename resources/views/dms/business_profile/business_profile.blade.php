        ...
        <div class="col-md-10">
            <div class="card mt-2" style="box-shadow:0 0 25px 0 lightgrey;">
                <div class="card-header">
                    <h3 class="bg-dark mt-2 rounded p-2 text-center text-white">Business Profile Details</h3>
                    <a class="m-r-15 text-muted edit btn btn-dark float-right mb-1 text-white" id="add">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card-body">
                            <div id="show_all_mrp" class="h-100 d-flex justify-content-center container">
