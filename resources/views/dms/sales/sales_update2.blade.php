    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card card-info mt-2" style="box-shadow:0 0 25px 0 lightgrey; transform:scaleY(.9);">
                ...
                <form class="form-horizontal" action="{{route('sale.sales_update_store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card-body">
                                ...
                                <div class="form-group row" style="margin-bottom:0px;">
                                    ...
                                    <div class="col-sm-9" style="padding:0px;">
                                        <select name="color_code" class="browser-default custom-select">
                                            ...
                                            <option {{$color->color_code == $data->color_code ? 'selected' : ''}} value="{{$color->color_code}}">{{$color->color}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="margin-bottom:0px;">
                                    ...
                                    <div class="col-sm-9" style="padding:0px;">
                                        <select name="print_ref" class="browser-default custom-select">
                                            ...
                                            <option {{$ref->print_ref == $data->print_ref ? 'selected' : ''}} value="{{$ref->print_ref}}">{{$ref->print_ref}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
